            ...
            */}
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link 
                  to="/datasite"
                  className="rounded-md bg-green-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600  hover:text-gray-900"
                >
                  Get started
                </Link>
                <a href="#" className="text-base font-semibold leading-7 text-gray-900 hover:text-green-600">
